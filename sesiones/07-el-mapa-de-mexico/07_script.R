...
# La versión resuelta (07_script_completo.R) se publica al terminar la sesión.
# ─────────────────────────────────────────────────────────────
...
# ← COMPLETA: ¿cuántos municipios trae municipios? Usa nrow().
...
# ← COMPLETA: verifica el CRS de municipios con st_crs(). Busca en
#   la salida el ID: debe decir EPSG 4326.
...
# ← COMPLETA: une municipios con resultados_municipio por
#   clave_municipio, y guarda el resultado en mapa_municipios.
...
# ← COMPLETA: arma el mapa con geom_sf(aes(fill = ventaja_shh)) sobre
#   mapa_municipios, una escala scale_fill_gradient2() centrada en
#   cero con los mismos tres colores de la sesión 6 (low = "#7B1113",
#   mid = "white", high = "#006847"), y una segunda capa de geom_sf()
#   con mapa_entidades encima, sin relleno (fill = NA, color = "white"),
#   para que se vean las fronteras estatales.
