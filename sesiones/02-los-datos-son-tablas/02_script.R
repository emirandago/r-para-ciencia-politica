...
# La versión resuelta (02_script_completo.R) se publica al terminar la sesión.
# ─────────────────────────────────────────────────────────────
...
# ← COMPLETA: cuenta cuantos NA hay en edad_legisladoras. La funcion se
#   llama sum(), combinada con is.na() -- exactamente como en la linea de
#   arriba, pero contando en vez de listar.
...
# ← COMPLETA: calcula el promedio de edad_legisladoras ignorando los NA.
#   Necesitas el argumento na.rm dentro de mean().
...
# ← COMPLETA: carga puente_claves_ine_inegi.csv en un objeto llamado
#   municipios, exactamente con el mismo patron que usamos para resultados.
