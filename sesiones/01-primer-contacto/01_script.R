...
# La versión resuelta (01_script_completo.R) se publica al terminar la sesión.
# ─────────────────────────────────────────────────────────────
...
# ← COMPLETA: arma un vector de números que se llame votos_ficticios, con
#   cuatro cifras cualesquiera. Acuérdate de c() y de las comas.
...
# ← COMPLETA: calcula la media de esa columna. La función se llama mean().
...
# Copia el bloque de arriba aquí abajo y cámbiale dos cosas:
#   1. el color, a "#00402C" (el verde profundo del curso);
#   2. el título, por una pregunta en vez de una descripción.
# Un buen título de gráfico dice qué hay que ver, no qué es.
